...
SECRET_KEY = 'django-insecure-q5g%u%%le%)v17o&@^vv$nj38)l0h!@!u1n*4+3ft8uwlel26-'
...
USE_L10N = True  # Activa la localización (formateo local de números y fechas)
...
# Agregar la carpeta qrcodes dentro de la carpeta static
STATICFILES_DIRS = [
